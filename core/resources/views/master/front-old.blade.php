                ...
                <div class="row pt-3 pb-3">
                    <div class="col-lg-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <!-- Toolbar-->
                            <div class="toolbar d-flex justify-content-between align-items-center p-2">
                                <!-- Mobile Search Icon -->
                                <div class="toolbar-item visible-on-mobile text-center">
                                ...
                                <div class="toolbar-item text-center">
                                    @if (!Auth::user())
                                        <div class="toolbar-item text-center">
                                            <a href="{{ route('user.login') }}" class="text-dark position-relative">
