...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form class="admin-form" action="{{ route('back.affiliate.update', $item->id) }}" method="POST"
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="affiliate_link" class="form-control" id="affiliate__link"
                                    placeholder="{{ __('Enter Affiliate Link') }}" value="{{ $item->affiliate_link }}">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group position-relative ">
                                ...
                                <br>
                                <span
                                    class="mt-1 text-info">{{ __('Image Size Should Be 800 x 1200. or square size') }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <input type="hidden" name="is_button" class="check_button" value="0">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <input type="hidden" name="sku" class="form-control" id="sku"
