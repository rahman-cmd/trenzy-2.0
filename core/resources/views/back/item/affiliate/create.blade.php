...
@section('content')
    <div class="container-fluid">
        ...
        <form class="admin-form tab-form" action="{{ route('back.affiliate.store') }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="affiliate_link" class="form-control" id="affiliate__link"
                                    placeholder="{{ __('Enter Affiliate Link') }}" value="{{ old('name') }}">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-info ">{{ __('Save & Edit') }}</button>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
