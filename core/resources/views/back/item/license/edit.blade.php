                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="file_type" name="file_type">
                                    <option value="file" {{ $item->file_type == 'file' ? 'selected' : '' }}>
                                        {{ __('File') }}</option>
                                    <option value="link" {{ $item->file_type == 'link' ? 'selected' : '' }}>
                                        {{ __('Link') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group view_file {{ $item->file_type == 'file' ? '' : 'd-none' }} ">
                                ...
                                @if (file_exists('assets/files/' . $item->file))
                                    <a download
                                        href="{{ asset('assets/files/' . $item->file) }}">{{ __('Download File') }}</a>
                                @endif
                            ...
                            <div class="form-group view_link {{ $item->file_type == 'link' ? '' : 'd-none' }}">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="link" name="link" class="form-control"
                                        value="{{ $item->link }}" placeholder="{{ __('Enter Link') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-btn">
                                                <button type="button" class="btn btn-success add-license"
                                                    data-text="{{ __('License Name') }}"
                                                    data-text1="{{ __('License Key') }}"> <i class="fa fa-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
