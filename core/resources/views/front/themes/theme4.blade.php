...
@section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{ isset($home_page4_banner['url1']) ? $home_page4_banner['url1'] : '' }}"
                            class="h3-category">
                            <img class="lazy" data-src="{{ asset('assets/images/' . $home_page4_banner['img1']) }}"
                                alt="">
                            <h4>{{ isset($home_page4_banner['label1']) ? $home_page4_banner['label1'] : '' }}</h4>
                        </a>
                        <a href="{{ isset($home_page4_banner['url2']) ? $home_page4_banner['url2'] : '' }}"
                            class="h3-category">
                            <img class="lazy" data-src="{{ asset('assets/images/' . $home_page4_banner['img2']) }}"
                                alt="">
                            <h4>{{ isset($home_page4_banner['label2']) ? $home_page4_banner['label2'] : '' }}</h4>
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 middleImage">
                        <a href="{{ isset($home_page4_banner['url3']) ? $home_page4_banner['url3'] : '' }}"
                            class="h3-category">
                            <img class="lazy" data-src="{{ asset('assets/images/' . $home_page4_banner['img3']) }}"
                                alt="">
                            <h4>{{ isset($home_page4_banner['label3']) ? $home_page4_banner['label3'] : '' }}</h4>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{ isset($home_page4_banner['url4']) ? $home_page4_banner['url4'] : '' }}"
                            class="h3-category">
                            <img src="{{ asset('assets/images/' . $home_page4_banner['img4']) }}" alt="">
                            <h4>{{ isset($home_page4_banner['label4']) ? $home_page4_banner['label4'] : '' }}</h4>
                        </a>
                        <a href="{{ isset($home_page4_banner['url5']) ? $home_page4_banner['url5'] : '' }}"
                            class="h3-category">
                            ...
                            @foreach ($chunk as $catimg)
                                <div class="col-4">
                                    <div class="category-cardd position-relative">
                                        <a style="color:#FF6A03;" href="{{ route('front.catalog') . '?category=' . $catimg->slug }}">
                                            <img src="{{ asset('assets/images/' . $catimg->photo) }}" alt="{{ $catimg->name }}" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                            @endforeach
    ...
    @php
        $getCategories = App\Models\Category::with('subcategory')->whereStatus(1)->orderby('serial', 'asc')->take(4)->get();
    @endphp
                ...
                <div class="col-md-3 col-sm-6 col-6">
                    <div class="category-cards position-relative">
                        ...
                        <div class="category-title text-light text-uppercase">
                            <a  style="color:#FF6A03;" href="{{ route('front.catalog') . '?category=' . $cat->slug }}">
                                {{ $cat->name }}
                            </a>
    ...
    @php
        $Categories_2 = App\Models\Category::with('subcategory')->whereStatus(1)->orderby('serial', 'asc')->skip(4)->take(4)->get();
    @endphp
            ...
            @foreach ($Categories_2 as $cat2)
                <div class="col-md-3 col-sm-6 col-6">
                    <div class="category-cards position-relative">
                        ...
                        <div class="category-title text-light text-uppercase">
                            <a style="color:#FF6A03;" href="{{ route('front.catalog') . '?category=' . $cat2->slug }}">{{ $cat2->name }}
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img class="lazy" data-src="{{ asset('assets/images/' . $service->photo) }}"
                                    alt="Shipping">
                                <div class="content">
