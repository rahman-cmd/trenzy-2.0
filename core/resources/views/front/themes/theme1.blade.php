...
@section('content')
                        ...
                        <div class="row justify-content-center mb-2">
                            <div class="col-lg-12 text-center">
                                <div class="section-title mb-4">
                                    <h2 class="h3 text-white-600 bold text-dark">{{ $setting->campaign_title }}</h2>
                                </div>
                                <div class="right-area">
                                    <div class="countdown countdown-alt d-inline-block"
                ...
                <div class="row g-3">
                    <div class="col-lg-12">
                                ...
                                <div class="slider-item">
                                    ...
                                    <div class="product-card">
                                        <div class="product-thumb">
                                            ...
                                            <!-- Thumbnail Image -->
                                            <img class="lazy"
                                                data-src="{{ asset('assets/images/' . $compaign_item->item->thumbnail) }}"
                                                alt="Product">

                                            {{-- <!-- Hover Video -->
                                            <video class="hover-video" muted loop>
                                                <source src="{{ asset('assets/videos/facebook-reel.mp4') }}"
                                                    type="video/mp4">
                                        ...
                                        <div class="product-card-body">
                                            <div class="product-category">
                                                <a
                                                    href="{{ route('front.catalog') . '?category=' . $compaign_item->item->category->slug }}">
                        ...
                        <div class="text-center mt-4">
                            <a class="btn btn-light border border-dark px-5 py-2" href="{{ route('front.campaign') }}">
    ...
    @if ($setting->is_popular_category == 1)
        <section class="newproduct-section popular-category-sec mt-20">
            <div class="p-3">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="row justify-content-center mb-2">
                            <div class="col-lg-12 text-center">
                                <div class="section-title mb-4">
                                    <h2 class="h3 text-white-600 bold text-dark">{{ $popular_category_title }}</h2>
                                    <div class="links">
                        ...
                        <div class="section-title">
                            <div class="links">
                                <a data-href="{{ route('front.get.product', 'feature') }}"
                                    ...
                                    class="product_get active">{{ __('Featured') }}</a>
        ...
        <section class="selected-product-section featured_cat_sec sps-two mt-50">
            <div class="p-3">
                <div class="row justify-content-center mb-2">
                    <div class="col-lg-12 text-center">
                        <div class="section-title mb-4">
                            <h2 class="h3 text-white-600 bold text-dark">{{ $feature_category_title }}</h2>
                            <div class="links">
                        ...
                        <div class="col-gd">
                            <div class="product-card">
                                <div class="product-thumb">
                                    ...
                                    @endif
                                    <img class="lazy"
                                        data-src="{{ asset('assets/images/' . $feature_category_item->thumbnail) }}"
                                        alt="Product">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        productThumbs.forEach(thumb => {
            const video = thumb.querySelector('.hover-video');

            thumb.addEventListener('mouseenter', () => {
                if (video) {
                    video.load(); // Load the video (lazy loading)
